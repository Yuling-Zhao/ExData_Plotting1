...
plot_1 <- hist(subset$Global_active_power, col = "red", main = "Global Active Power", xlab = "Global Active Power (kilowatts)")

plot_2 <- plot(x = subset$day_time, y = subset$Global_active_power, type = "l")

x = rnorm(10)
y = rnorm(10)
plot(x, subset$day_time, type = "n")
plot(x[subset$Sub_metering_1], y[subset$day_time], type = "l")
