...
par(mfrow = c(2, 2))
plot(x = subset$day_time, y = subset$Global_active_power, type = "l", ylab = "Global Active Power", xlab = "")
plot(x = subset$day_time, y = subset$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")

plot(x = subset$day_time, y = subset$Sub_metering_1, type = "n", ylab = "Energy sub metering", xlab = "")
...
plot(x = subset$day_time, y = subset$Global_reactive_power, type = "l", xlab = "datetime")
